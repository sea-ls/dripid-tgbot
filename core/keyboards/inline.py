...
"6. Какой курс валют?": """Актуальный курс валют вы можете увидеть, если сделаете расчёт своего заказа через нашего бота \(а собственно вы в нем и находитесь, так что жмите /calculate\_cost\_order\) \(добавить кнопку чтобы перекидовало на расчет\)""",

"7. Как отследить заказ?": """После оформления заказа менеджер предоставит вам трек номер, а статус по нему можно отследить, нажав /get\_order\_status"""
